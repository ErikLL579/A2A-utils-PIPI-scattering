...
Transforms Wick contraction output (from Luchang's qlat autocontraction) into A2A meson field form. See `autocontraction-symbolic-manipulation/AGENTS.md` for detailed documentation of:
...
For full Grid documentation see `~/Documents/Physics/lattice/Grid_tests/Grid/AGENTS.md`. Key patterns for this project:
